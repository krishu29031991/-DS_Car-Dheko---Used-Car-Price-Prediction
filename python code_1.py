...
df.drop(columns=["Cargo Volumn","Acceleration", "car_links", "bt", "Engine Displacement", "Gear Box", "Color", "Max Power", "Max Torque",
                 "features_top", "model", "oem","Cargo Volumn_litres","priceActual_in_lakh","Front Tread_in_mm", "trendingText", "variantName", "Engine", "Transmission", "ft",
                 "price", "priceActual", "Front Tread", "Mileage", "Kms Driven", "BoreX Stroke","Alloy Wheel Size",
...
output_path = r"C:\Users\10732370\OneDrive - LTIMindtree\Documents\guvi\Project 3 Cardheko\all_cars_testing2.xlsx"
